...
hora = c2.slider('Hora en la que ocurrió el suceso',0, 23) # Crear variable que me almacene la hora seleccionada
...
c2.write(pdk.Deck( # Código para crear el mapa
    ...
    layers = [pdk.Layer(
        ...
        get_position = ['longitude','latitude'], # columnas donde se encuentra la longitud y latitud
        radius = 100,
        extruded = True, # permitir elevación de las barras
        elevation_scale = 4,
